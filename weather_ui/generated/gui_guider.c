...
void init_scr_del_flag(lv_ui *ui)
{
    ...
    ui->Clock_View_del = true;
    ui->Digit_View_del = true;
    ui->Weather_View_del = true;
    ui->Music_View_del = true;
    ui->StopWatch_View_del = true;
    ui->Caculator_View_del = true;
    ui->Wifi_View_del = true;
